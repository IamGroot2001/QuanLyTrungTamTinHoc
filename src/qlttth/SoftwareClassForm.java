 ...
 * @author lengo
 */
public class SoftwareClassForm extends javax.swing.JFrame {

    /**
     * Creates new form SoftwareClassForm
     */
    public SoftwareClassForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Software developer class");

        jTabbedPane1.setBackground(new java.awt.Color(137, 196, 244));

        jPanel2.setBackground(new java.awt.Color(103, 128, 159));

        jButton9.setText("Class 01.02");

        jButton10.setText("Class 01.03");

        jButton11.setText("Class 01.04");

        jButton12.setText("Class 01.01");

        jButton13.setText("Class 01.08");

        jButton14.setText("Class 01.07");

        jButton15.setText("Class 01.06");

        jButton16.setText("Class 01.05");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SoftwareClassForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SoftwareClassForm().setVisible(true);
            }
        });
    }
